...
namespace DTN.Web.Middlewares
{
    public class CustomExceptionHandlingMiddleware
    {
        ...
        private Task HandleGlobalExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            {
                Log.ForContext("ValidationError", exception.Message).Warning("Validation error occurred in API.");
            ...
            else
            {
                ...
                Log.ForContext("ErrorId", errorId).Error(exception, "Error occured in API");
